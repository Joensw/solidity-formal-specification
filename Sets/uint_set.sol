...
// invariant forall (uint i) forall (uint j) !(self.location[i] == 0) || !(0 <= j && j < self.items.length) || (self.items[j] != i)
// invariant forall (uint i) !(self.location[i] != 0) || (self.location[i] - 1 < self.items.length) && (self.items[self.location[i] - 1] == i)
// invariant forall (uint i) !(0 <= i && i < self.items.length) || (self.location[self.items[i]] - 1 == i)
...
library Sets {
    ...
    /// @notice precondition forall (uint i) forall (uint j) !(self.location[i] == 0) || !(0 <= j && j < self.items.length) || (self.items[j] != i)
    /// @notice postcondition forall (uint i) forall (uint j) !(self.location[i] == 0) || !(0 <= j && j < self.items.length) || (self.items[j] != i)
    ...
    /// @notice precondition forall (uint i) !(self.location[i] != 0) || (self.location[i] - 1 < self.items.length) && (self.items[self.location[i] - 1] == i)
    /// @notice postcondition forall (uint i) !(self.location[i] != 0) || (self.location[i] - 1 < self.items.length) && (self.items[self.location[i] - 1] == i)
    ...
    /// @notice postcondition forall (uint i) __verifier_old_uint(self.location[num]) != 0 || !(0 <= i && i < self.items.length - 1) || (self.items[i] == __verifier_old_uint(self.items[i]))
    ...
    /// @notice postcondition forall (uint i) __verifier_old_uint(self.location[num]) == 0 || !(0 <= i && i < self.items.length) || (self.items[i] == __verifier_old_uint(self.items[i]))
    ...
    /// @notice postcondition forall (uint i) success || !(0 <= i && i < self.items.length) || (self.items[i] == __verifier_old_uint(self.items[i]))
    ...
    /// @notice postcondition forall (uint i) (!success) || !(num == __verifier_old_uint(self.items[self.items.length - 1])) || !(i != num) || self.location[i] == __verifier_old_uint(self.location[i])
    /// @notice postcondition forall (uint i) (!success) || !(num == __verifier_old_uint(self.items[self.items.length - 1])) || !(0 <= i && i < self.items.length) || (self.items[i] == __verifier_old_uint(self.items[i]))
    /// @notice postcondition forall (uint i) (!success) || (num == __verifier_old_uint(self.items[self.items.length - 1])) || !(0 <= i && i < self.items.length && i != __verifier_old_uint(self.location[num] - 1)) || (self.items[i] == __verifier_old_uint(self.items[i]))
    /// @notice postcondition (!success) || (num == __verifier_old_uint(self.items[self.items.length - 1])) || self.items[__verifier_old_uint(self.location[num] - 1)] == __verifier_old_uint(self.items[self.items.length - 1])
    /// @notice postcondition (!success) || (num == __verifier_old_uint(self.items[self.items.length - 1])) || self.location[__verifier_old_uint(self.items[self.items.length - 1])] == __verifier_old_uint(self.location[num])
    /// @notice postcondition forall (uint i) (!success) || (num == __verifier_old_uint(self.items[self.items.length - 1])) || !(i != __verifier_old_uint(self.items[self.items.length - 1]) && i != num) || (self.location[i] == __verifier_old_uint(self.location[i]))
    ...
    function remove(Set storage self, uint num) public returns (bool success) {
        ...
        uint last = self.items[self.items.length - 1];
