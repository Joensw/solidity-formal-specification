...
library IterableMappings {
    ...
    function get(IterableMapping storage self, address _key) public view returns (bool value) {
    ...
    /// @notice postcondition forall (address a) !(a != _key) || self.values[a] == __verifier_old_bool(self.values[a])
    ...
    function set(IterableMapping storage self, address _key, bool _value) public {
    ...
    /// @notice postcondition forall (address a) success || self.values[a] == __verifier_old_bool(self.values[a])
    ...
    /// @notice postcondition forall (address a) !success || !(a != _key) || self.values[a] == __verifier_old_bool(self.values[a])
