...
library IterableMappings {
    ...
    function get(IterableMapping storage self, address _key) public view returns (address value) {
    ...
    /// @notice postcondition forall (address a) !(a != _key) || self.values[a] == __verifier_old_address(self.values[a])
    ...
    function set(IterableMapping storage self, address _key, address _value) public {
    ...
    /// @notice postcondition forall (address a) success || self.values[a] == __verifier_old_address(self.values[a])
    ...
    /// @notice postcondition forall (address a) !success || !(a != _key) || self.values[a] == __verifier_old_address(self.values[a])
    ...
    /// @notice postcondition exists (uint i) !success || __verifier_old_address(self.keys[i]) == _key
    /// @notice postcondition forall (uint i) success || !(0 <= i && i < __verifier_old_uint(self.keys.length)) || __verifier_old_address(self.keys[i]) != _key
