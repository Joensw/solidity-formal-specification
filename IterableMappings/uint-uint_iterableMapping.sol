...
library IterableMappings {
    ...
    function get(IterableMapping storage self, uint _key) public view returns (uint value) {
    ...
    /// @notice postcondition forall (uint a) !(a != _key) || self.values[a] == __verifier_old_uint(self.values[a])
    ...
    function set(IterableMapping storage self, uint _key, uint _value) public {
    ...
    /// @notice postcondition forall (uint a) success || self.values[a] == __verifier_old_uint(self.values[a])
    ...
    /// @notice postcondition forall (uint a) !success || !(a != _key) || self.values[a] == __verifier_old_uint(self.values[a])
