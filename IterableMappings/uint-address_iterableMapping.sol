...
library IterableMappings {
    ...
    function get(IterableMapping storage self, uint _key) public view returns (address value) {
    ...
    /// @notice postcondition forall (uint a) !(a != _key) || self.values[a] == __verifier_old_address(self.values[a])
    ...
    function set(IterableMapping storage self, uint _key, address _value) public {
    ...
    /// @notice postcondition forall (uint a) success || self.values[a] == __verifier_old_address(self.values[a])
    ...
    /// @notice postcondition forall (uint a) !success || !(a != _key) || self.values[a] == __verifier_old_address(self.values[a])
