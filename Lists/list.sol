...
library Lists {
    ...
    /// @notice postcondition exists (uint i) !(success) || (i >= 0 && i < __verifier_old_uint(self.items.length) && __verifier_old_%TYPE%(self.items[i]) == val) 
    /// @notice postcondition forall (uint i) !(i >= 0 && i < __verifier_old_uint(self.items.length) && __verifier_old_%TYPE%(self.items[i]) == val) || (success)
    ...
    /// @notice postcondition forall (uint i) !(i >= 0 && i < __verifier_old_uint(self.items.length) && __verifier_old_%TYPE%(self.items[i]) == val) || (valid)
    /// @notice postcondition exists (uint i) !(valid) || (i >= 0 && i < __verifier_old_uint(self.items.length) && __verifier_old_%TYPE%(self.items[i]) == val)  
    ...
    /// @notice postcondition forall (uint i) !(i >= 0 && i < index) || (self.items[i] == __verifier_old_%TYPE%(self.items[i]))
    /// @notice postcondition forall (uint i) !(i > index && i < self.items.length) || (self.items[i] == __verifier_old_%TYPE%(self.items[i]))
    /// @notice postcondition self.items[index] == newValue

    function set(List storage self, uint index, %TYPE% newValue) public {
        require(index < self.items.length);
        require(index >= 0);
