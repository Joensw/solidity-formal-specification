...
library Lists {
    ...
    /// @notice postcondition exists (uint i) !(success) || (i >= 0 && i < __verifier_old_uint(self.items.length) && __verifier_old_uint(self.items[i]) == val) 
    /// @notice postcondition forall (uint i) !(i >= 0 && i < __verifier_old_uint(self.items.length) && __verifier_old_uint(self.items[i]) == val) || (success)
    ...
    /// @notice postcondition forall (uint i) !(i >= 0 && i < __verifier_old_uint(self.items.length) && __verifier_old_uint(self.items[i]) == val) || (valid)
    /// @notice postcondition exists (uint i) !(valid) || (i >= 0 && i < __verifier_old_uint(self.items.length) && __verifier_old_uint(self.items[i]) == val)  
