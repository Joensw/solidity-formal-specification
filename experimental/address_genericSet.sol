...
library Sets {
    ...
    /// @notice precondition forall (address i) forall (uint j) !(self.location[i] == 0) || !(0 <= j && j < self.values.length) || (self.values[j] != i)
    /// @notice postcondition forall (address i) forall (uint j) !(self.location[i] == 0) || !(0 <= j && j < self.values.length) || (self.values[j] != i)
    ...
    /// @notice precondition forall (address i) !(self.location[i] != 0) || (self.location[i] - 1 < self.values.length) && (self.values[self.location[i] - 1] == i)
    /// @notice postcondition forall (address i) !(self.location[i] != 0) || (self.location[i] - 1 < self.values.length) && (self.values[self.location[i] - 1] == i)
    ...
    */
    ...
    /// @notice postcondition forall (uint i) __verifier_old_uint(self.location[num]) != 0 || !(0 <= i && i < self.values.length - 1) || (self.values[i] == __verifier_old_address(self.values[i]))
    ...
    /// @notice postcondition forall (uint i) __verifier_old_uint(self.location[num]) == 0 || !(0 <= i && i < self.values.length) || (self.values[i] == __verifier_old_address(self.values[i]))
    ...
    */
    ...
    /// @notice postcondition forall (uint i) success || !(0 <= i && i < self.values.length) || (self.values[i] == __verifier_old_address(self.values[i]))
    ...
    /// @notice postcondition forall (address i) (!success) || !(num == __verifier_old_address(self.values[self.values.length - 1])) || !(i != num) || self.location[i] == __verifier_old_uint(self.location[i])
    /// @notice postcondition forall (uint i) (!success) || !(num == __verifier_old_address(self.values[self.values.length - 1])) || !(0 <= i && i < self.values.length) || (self.values[i] == __verifier_old_address(self.values[i]))
    /// @notice postcondition forall (uint i) (!success) || (num == __verifier_old_address(self.values[self.values.length - 1])) || !(0 <= i && i < self.values.length && i != __verifier_old_uint(self.location[num] - 1)) || (self.values[i] == __verifier_old_address(self.values[i]))
    /// @notice postcondition (!success) || (num == __verifier_old_address(self.values[self.values.length - 1])) || self.values[__verifier_old_uint(self.location[num] - 1)] == __verifier_old_address(self.values[self.values.length - 1])
    /// @notice postcondition (!success) || (num == __verifier_old_address(self.values[self.values.length - 1])) || self.location[__verifier_old_address(self.values[self.values.length - 1])] == __verifier_old_uint(self.location[num])
    /// @notice postcondition forall (address i) (!success) || (num == __verifier_old_address(self.values[self.values.length - 1])) || !(i != __verifier_old_address(self.values[self.values.length - 1]) && i != num) || (self.location[i] == __verifier_old_uint(self.location[i]))
    ...
    function remove(Set storage self, address num) public returns (bool success) {
        ...
        address last = self.values[self.values.length - 1];
    ...
    function get(Set storage self, uint index) public view returns (address ret) {
